...
public class CarRpcClientTest {
	...
	public final void testQueryOrderInfo() {
		...
		String message = service.queryOrderInfo(orderCode, clientCode,
				clientKey);
		System.err.println(message);
		Assert.assertNotNull(message);
	}
	...
	public final void testAddNewUser() {
		...
		String city = "4501";
		String message = service.addNewUser(wxName, wxCode, carCode, city,
				trueName, phone, address, certCode, email, clientCode,
				clientKey);
		System.err.println(message);
		Assert.assertNotNull(message);
	}
	...
	public final void testAddNewOrder() {
		...
		String message = service.addNewOrder(wxCode, partMapLb, clientCode,
				clientKey);
		System.err.println(message);
		Assert.assertNotNull(message);
	}
	...
	public final void testFitOrderStatusToCancelIn() {
		String orderCode = "DT20141024162405DD10000003";
		String message = service.fitOrderStatusToCancelIn(orderCode,
	...
	public final void testFitOrderStatusToPayAndOut() {
		String orderCode = "DT20141024162405DD10000003";
		String message = service.fitOrderStatusToPayAndOut(orderCode,
				clientCode, clientKey);
		System.err.println(message);
		Assert.assertNotNull(message);
	}
	...
	public final void testFitOrderStatusToFreePark() {
		String orderCode = "DT20141024162405DD10000003";
		String message = service.fitOrderStatusToFreePark(orderCode,
				clientCode, clientKey);
		System.err.println(message);
		Assert.assertNotNull(message);
	}
	...
	public final void testQueryErrorInfo() {
		...
		String message = service.queryErrorInfo(errorCode, clientCode,
				clientKey);
		System.err.println(message);
		Assert.assertNotNull(message);
	}
